...
## HOW TO LAUNCH UI FROM ANY COMMAND PROMPT WINDOW: 
### *(Recommended)*  
...
- Place the Symlink.bat file into the Scripts folder you made
...
- Paste the path of your Scripts folder you made — it should look like:
...
This will display the creator mini UI whenever you want it :)
...
![](https://github-view-counter-1-0-0.vercel.app/api?username=landnthrn-Symlink-Creator&label=false&bgColor=20164C&color=6a5acd&iconColor=6a5acd)
